...
FilterNBaseMuons = Producer(
    ...
    input=[q.nbasemuons],
    output=None,
    scopes=["m2m_dyfakeingmu_regionc","m2m_dyfakeingmu_regiond","e2m_dyfakeinge_regionc","e2m_dyfakeinge_regiond","mmmm_cr"],
)
# write by botao
### e2m
...
DimuonMinMassCut = Producer(
    ...
    output=None,
    scopes=["m2m","e2m","eemm","eemm_cr","mmmm","mmmm_cr","nnmm","fjmm","fjmm_cr",
...
FilterFlagLepChargeSum = Producer(
    ...
    output=None,
    scopes=["e2m","m2m","eemm","eemm_cr","mmmm","mmmm_cr","nnmm","fjmm","fjmm_cr","nnmm_dycontrol","nnmm_topcontrol","m2m_dyfakeingmu_regionb","m2m_dyfakeingmu_regionc","m2m_dyfakeingmu_regiond","e2m_dyfakeinge_regionb","e2m_dyfakeinge_regionc","e2m_dyfakeinge_regiond"],
)
FilterFlagGoodEleVeto = Producer(
    ...
    output=None,
    scopes=["m2m","mmmm","mmmm_cr","nnmm","fjmm","fjmm_cr","nnmm_dycontrol","m2m_dyfakeingmu_regionb","m2m_dyfakeingmu_regionc","m2m_dyfakeingmu_regiond"],
)
...
PassFlagDiMuonHiggs = Producer(
    ...
    scopes=["mmmm","mmmm_cr"], # already done in ZZ Veto (exist H and Z)
)
...
### to make sure the muons from Higgs are good
FlagGoodMuonsFromHiggs = Producer(
    name="FlagGoodMuonsFromHiggs",
    call='physicsobject::CheckGoodMuon({df}, {output}, {input})',
    input=[
          q.good_muon_collection,
          q.quadmuon_HiggsZCand_collection
        ],
    output=[q.FlagGoodMuonsFromHiggs],
    scopes=["mmmm_cr"],
)
...
##################################
### deta fatjet and H
fatjet_mmH_deta_corrected = Producer(
    name="fatjet_mmH_deta_corrected",
    call='quantities::deltaEta({df}, {output}, {input})',
    input=[
      q.fatjet_p4_1,
      q.dimuon_p4_Higgs_corrected,
...
### dphi fatjet and H
fatjet_mmH_dphi_corrected = Producer(
    name="fatjet_mmH_dphi_corrected",
    call='quantities::deltaPhi({df}, {output}, {input})',
    input=[
      q.fatjet_p4_1,
      q.dimuon_p4_Higgs_corrected,
...
### dR fatjet and H
fatjet_mmH_dR_corrected = Producer(
    name="fatjet_mmH_dR_corrected",
    call='quantities::deltaR({df}, {output}, {input})',
    input=[
      q.fatjet_p4_1,
      q.dimuon_p4_Higgs_corrected,
...
##################################
### deta fatjet and mu1
fatjet_mu1_deta_corrected = Producer(
    name="fatjet_mu1_deta_corrected",
    call='quantities::deltaEta({df}, {output}, {input})',
    input=[
      q.fatjet_p4_1,
      q.muon_leadingp4_H_corrected,
...
### dphi fatjet and mu1
fatjet_mu1_dphi_corrected = Producer(
    name="fatjet_mu1_dphi_corrected",
    call='quantities::deltaPhi({df}, {output}, {input})',
    input=[
      q.fatjet_p4_1,
      q.muon_leadingp4_H_corrected,
...
### dR fatjet and mu1
fatjet_mu1_dR_corrected = Producer(
    name="fatjet_mu1_dR_corrected",
    call='quantities::deltaR({df}, {output}, {input})',
    input=[
      q.fatjet_p4_1,
      q.muon_leadingp4_H_corrected,
...
##################################
### deta fatjet and mu2
fatjet_mu2_deta_corrected = Producer(
    name="fatjet_mu2_deta_corrected",
    call='quantities::deltaEta({df}, {output}, {input})',
    input=[
      q.fatjet_p4_1,
      q.muon_subleadingp4_H_corrected,
...
### dphi fatjet and mu2
fatjet_mu2_dphi_corrected = Producer(
    name="fatjet_mu2_dphi_corrected",
    call='quantities::deltaPhi({df}, {output}, {input})',
    input=[
      q.fatjet_p4_1,
      q.muon_subleadingp4_H_corrected,
...
### dR fatjet and mu2
fatjet_mu2_dR_corrected = Producer(
    name="fatjet_mu2_dR_corrected",
    call='quantities::deltaR({df}, {output}, {input})',
    input=[
      q.fatjet_p4_1,
      q.muon_subleadingp4_H_corrected,
