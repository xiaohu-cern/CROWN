...
struct CrystalBall_R{
    ...
    CrystalBall_R():m(0),s(1),a(10),n(10){
	init();
    }
...
class RoccoR{
	...
	double kEffDifferror1(int Q, double pt, double eta, double phi, int n, double u) const;
	double kEffDifferror2(int Q, double pt, double eta, double phi, double gt) const;
};
