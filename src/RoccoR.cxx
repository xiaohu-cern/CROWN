...
const double CrystalBall_R::pi = 3.14159;
const double CrystalBall_R::sqrtPiOver2 = sqrt(CrystalBall_R::pi/2.0);
const double CrystalBall_R::sqrt2 = sqrt(2.0);
...
const double RoccoR::MPHI=-CrystalBall_R::pi;
...
double RoccoR::kEffDifferror1(int Q, double pt, double eta, double phi, int n, double u) const{
	return error([this, Q, pt, eta, phi, n, u](int s, int m){return kSmearMC(Q, pt, eta, phi, n, u, s, m)*kScaleDT(Q, pt, eta, phi, 0, 0)/kScaleDT(Q, pt, eta, phi, s, m);});
}

double RoccoR::kEffDifferror2(int Q, double pt, double eta, double phi, double gt) const{
	return error([this, Q, pt, eta, phi, gt](int s, int m){return kSpreadMC(Q, pt, eta, phi, gt, s, m)*kScaleDT(Q, pt, eta, phi, 0, 0)/kScaleDT(Q, pt, eta, phi, s, m);});
}
